         ...
         <div className="flex flex-col gap-8 justify-center items-center w-full h-fit my-4 pl-4 pr-4">
                ...
                <div className=" relative   mt-4 h-12 input-component mb-5 w-full rounded-xl">
                    ...
                    <div id="dropdown2" className={`h-36 overflow-auto w-full   bg-white border border-black divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 ${
                        ...
                        <ul className="z-10  w-full  text-sm text-black dark:text-gray-200" aria-labelledby="dropdownDefaultButton2">
                        <li>
               ...
               <div className=" relative   mt-4 h-12 input-component mb-5 w-full rounded-xl">
                    ...
                    <div id="dropdown3" className={`h-36 overflow-auto w-full  bg-white border border-black divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 ${
                   isOpen3 ? "block" : "hidden"
                    }`}>
                        <ul className="z-10  w-full text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton3">
                        <li>
