         ...
         <div className="flex flex-col gap-4 justify-center items-center w-full h-fit  pl-4 pr-4">
           <p className="text-left w-full pt-4 font-deacon13">Mr : XXX XXXX</p>
               ...
               <a href="#" className="h-16   block  pl-4 pr-4  bg-white border border-gray-200 rounded-2xl shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    ...
                    <p className="font-deacon13 mb-2 text-blue1 text-sm font-bold tracking-tight text-gray-900 dark:text-white font-sm">Phone</p>
                    <p className="font-deacon13 mb-2 font-normal text-gray1 dark:text-gray1 ">081-234-5678</p>
                    </a>
               </div>
               <div className="w-full h-27">
               <a href="#" className="h-16 block pl-4 pr-4  bg-white border border-gray-200 rounded-2xl shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            
                    <p className="font-deacon13 mb-2 text-blue1 text-sm font-bold tracking-tight text-gray-900 dark:text-white font-sm">E-mail</p>
                    <p className="font-deacon13 mb-2 font-normal text-gray1  dark:text-gray1 ">loremipsum@gmail.com</p>
                    </a>
               </div>
               <div className="w-full h-27">
               <a href="#" className="h-16 block pl-4 pr-4  bg-white border border-gray-200 rounded-2xl shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            
                    <p className="font-deacon13 mb-2 text-blue1 text-sm font-bold tracking-tight text-gray-900 dark:text-white font-sm">Interested model</p>
                    <p className="font-deacon13 mb-2 font-normal text-gray1  dark:text-gray1 ">Hyper HT</p>
                    </a>
               </div>
               <div className="w-full h-27">
               <a href="#" className="h-16 block  pl-4 pr-4  bg-white border border-gray-200 rounded-2xl shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            
                    <p className="font-deacon13 mb-2 text-blue1 text-sm font-bold tracking-tight text-gray-900 dark:text-white font-sm">Plan for Car Purchasing</p>
                    <p className="font-deacon13 mb-2 font-normal text-gray1  dark:text-gray1 ">1 month</p>
                    </a>
               </div>
               <div className="w-full h-27 mb-4">
               <a href="#" className="h-16 block  pl-4 pr-4  bg-white border border-gray-200 rounded-2xl shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            
                    <p className="font-deacon13 mb-2 text-blue1 text-sm font-bold tracking-tight text-gray-900 dark:text-white font-sm">Dealer</p>
                    <p className="font-deacon13 mb-2 font-normal text-gray1  dark:text-gray1 ">V Group</p>
                    </a>
               </div>
      ...
      <div className="w-full   bg-cream  overflow-hidden shadow-lg bg-white border  rounded-2xl mt-8">
         ...
         <div className=" relative   mt-4 h-12 input-component mb-5 w-full">
                    <div className="relative group ">
                        ...
                        <p className="font-deacon13 w-full pl-4 justify-start flex">25 มีนาคม 2567</p>
                    ...
                    <label htmlFor="model" className="font-deacon13 absolute text-sm left-2 transition-all text-blue2 bg-white px-1">
                ...
                <div className=" relative   mt-4 h-12 input-component mb-5 w-full">
                    <div className="relative group ">
                        ...
                        <p className="font-deacon13 w-full pl-4 justify-start flex">11:00</p> 
                        <div className="justify-end flex w-full">
                            <svg className="w-2.5 h-2.5 ms-3 mr-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                            </svg>
              ...
              <p className="mb-2 ml-2 text-sm text-blue2 font-deacon13 ">Do you have a driver license?/ คุณมีใบขับขี่หรือไม่?*</p>
               <div className=" flex columns-2 p-4">
                    <div className=" items-center w-full ">
                        ...
                        <label  className="ms-2 text-lg  text-gray-900 dark:text-gray-300 font-deacon13">มี</label>
                    </div>
                    <div className=" items-center w-full ">
                        <input id="link-checkbox" type="checkbox" value="" className="w-4 h-4 text-black bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                        <label  className="ms-2 text-lg  text-gray-900 dark:text-gray-300 font-deacon13">ไม่มี</label>
                    </div>
               </div>
